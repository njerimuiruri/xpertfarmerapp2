...
const FeedingManagementScreen = ({ navigation }) => {
  return (
    <View style={{ flex: 1, backgroundColor: COLORS.light }}>
      <SecondaryHeader title="Feeding Records" />
      ...
      <View style={styles.contentContainer}>
        ...
        <Text style={styles.subText}>You’ve not set your feeding details yet</Text>
      </View>
...
export default FeedingManagementScreen;
