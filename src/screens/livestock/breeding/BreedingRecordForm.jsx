...
const BreedingRecordForm = ({ navigation }) => {
  ...
  useEffect(() => {
    if (formData.sireId) {
      ...
      if (formData.serviceType === 'Natural Mating') {
        setFormData(prev => ({
          ...prev,
          aiType: '',
          aiSource: '',
  ...
  return (
    <SafeAreaView style={styles.container}>
        ...
        <View style={styles.submitContainer}>
          <TouchableOpacity
            ...
            {loading ? (
              ...
              <>
                <FastImage source={icons.add} style={styles.submitIcon} tintColor={COLORS.white} />
      ...
      <ModernSuccessModal
        ...
        title="Success!"
        message="Breeding record has been created successfully. You can now track the breeding progress and record births when they occur."
      />
