...
const initialDairyData = [
  {
    ...
    dailyMilkYield: 30,
    milkQuality: 'High',
    lactationPeriod: '01/01/2023',
    dryingOffPeriod: '07/01/2023',
    saleQuantity: 25,
    saleDate: '15/01/2023',
    marketPrice: 80,
    salePrice: 2000,
  ...
  },
  {
    ...
    dailyMilkYield: 25,
    milkQuality: 'Medium',
    lactationPeriod: '01/02/2023',
    dryingOffPeriod: '08/01/2023',
    saleQuantity: 20,
    saleDate: '15/02/2023',
    marketPrice: 78,
    salePrice: 1800,
  ...
  },
  {
    ...
    dailyMilkYield: 28,
    milkQuality: 'High',
    lactationPeriod: '01/03/2023',
    dryingOffPeriod: '09/01/2023',
    saleQuantity: 28,
    saleDate: '15/03/2023',
    marketPrice: 82,
    salePrice: 2100,
  ...
  },
  {
    ...
    lactationPeriod: '01/04/2023',
    dryingOffPeriod: '10/01/2023',
    saleQuantity: 30,
    saleDate: '15/04/2023',
    marketPrice: 85,
    salePrice: 2200,
  ...
  },
  {
    ...
    dailyMilkYield: 27,
    milkQuality: 'Good',
    lactationPeriod: '01/05/2023',
    dryingOffPeriod: '11/01/2023',
    saleQuantity: 22,
    saleDate: '15/05/2023',
    marketPrice: 79,
    salePrice: 1900,
...
const DairyProductionListScreen = ({ navigation }) => {
  const [dairyRecords, setDairyRecords] = useState(initialDairyData);
  const [searchQuery, setSearchQuery] = useState('');
  const [filterStatus, setFilterStatus] = useState('All');

  const filteredRecords = useMemo(() => {
    let filtered = dairyRecords;
    ...
    return filtered;
  }, [dairyRecords, searchQuery, filterStatus]);
    ...
    Alert.alert(
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          style: 'destructive',
          onPress: () => {
            setDairyRecords(prev => prev.filter(item => item.id !== id));
          },
        },
      ],
    );
  ...
  const handleViewDetails = useCallback(
    (record) => {
      navigation.navigate('DairyDetailsScreen', { dairyRecord: record });
    },
    [navigation],
  );
  ...
  const renderEmptyState = () => (
    <View style={styles.emptyContainer}>
      ...
      />
      <Text style={styles.emptyTitle}>No Dairy Records Found</Text>
      <Text style={styles.emptySubtitle}>
        {searchQuery
          ? "Try adjusting your search"
          : "Add your first dairy production record"}
      </Text>
      <TouchableOpacity
      ...
      <View style={styles.cardBody}>
        <View style={styles.dataRow}>
          <View style={styles.dataItem}>
            <Text style={styles.dataLabel}>Daily Yield</Text>
            <Text style={styles.dataValue}>{item.dailyMilkYield} L</Text>
          </View>
          <View style={styles.dataItem}>
            <Text style={styles.dataLabel}>Quality</Text>
            <Text style={styles.dataValue}>{item.milkQuality}</Text>
          </View>
          <View style={styles.dataItem}>
