...
const PayrollJournalScreen = () => {
    ...
    const payrollJournalData = [
        ...
        },
        {
            id: 6,
            date: '2025-05-31',
            description: 'Payment of Net Salaries',
            account: 'Salaries Payable',
            debit: 96000,
            credit: null
        },
        ...
        },
        {
            id: 8,
            date: '2025-05-31',
            description: 'PAYE Payment to KRA',
            account: 'PAYE Payable',
            debit: 18000,
            credit: null
        },
    ...
    const filterOptions = {
        account: ['all', 'Salaries and Wages', 'PAYE Payable', 'NSSF Payable', 'NHIF Payable', 'Salaries Payable', 'Bank/Cash'],
    ...
    const filteredAndSortedData = useMemo(() => {
        let filtered = payrollJournalData;
        ...
        return filtered;
    }, [payrollJournalData, searchQuery, selectedFilters, sortBy, sortOrder]);
        ...
        <View style={styles.container}>
            ...
            >
                <View style={styles.headerContent}>
                    ...
                    <View style={styles.headerTextContainer}>
                        <Text style={styles.headerTitle}>Payroll Journal</Text>
                        <Text style={styles.headerSubtitle}>Track all payroll-related transactions</Text>
                    </View>
            ...
            <View style={styles.summarySection}>
                <Text style={styles.summaryText}>
                    Showing {filteredAndSortedData.length} of {payrollJournalData.length} entries
                </Text>
...
export default PayrollJournalScreen;