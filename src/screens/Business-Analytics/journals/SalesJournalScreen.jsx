...
const SalesJournalScreen = () => {
    ...
    const salesJournalData = [
        {
            id: 1,
            date: '2025-05-11',
            description: 'Sold 500L of milk to Local Dairy',
            account: 'Cash/Bank',
            debit: 750,
            credit: null
        },
        {
            id: 2,
            date: '2025-05-11',
            description: 'Revenue from milk sales',
            account: 'DairySales',
            debit: null,
            credit: 750
        },
        {
            id: 3,
            date: '2025-05-20',
            description: 'Sold 200L of milk to Retail Store',
            account: 'Cash/Bank',
            debit: 340,
            credit: null
        },
        ...
        },
        {
            id: 5,
            date: '2025-05-14',
            description: 'Sold 500kg of beef to KMC',
            account: 'Cash/Bank',
            debit: 2000,
            credit: null
        },
        {
            id: 6,
            date: '2025-05-14',
            description: 'Revenue from beef sales to KMC',
            account: 'BeefSales',
            debit: null,
            credit: 2000
        },
        {
            id: 7,
            date: '2025-05-14',
            description: 'Sold 300kg of beef to Beef Market',
            account: 'Cash/Bank',
            debit: 1500,
            credit: null
        },
        {
            id: 8,
            date: '2025-05-14',
            description: 'Revenue from beef sales to Beef Market',
            account: 'BeefSales',
            debit: null,
            credit: 1500
        }
    ...
    const filterOptions = {
        account: ['all', 'Cash/Bank', 'DairySales', 'BeefSales'],
    ...
    const filteredAndSortedData = useMemo(() => {
        ...
        return filtered;
    }, [salesJournalData, searchQuery, selectedFilters, sortBy, sortOrder]);
    ...
    const handleExport = () => {
        Alert.alert(
            ...
            [
                {
                    text: 'CSV',
                    onPress: () => Alert.alert('Success', 'Sales data exported to CSV format')
                },
                {
                    text: 'Excel',
                    onPress: () => Alert.alert('Success', 'Sales data exported to Excel format')
                },
                {
                    text: 'PDF',
                    onPress: () => Alert.alert('Success', 'Sales data exported to PDF format')
                },
                {
                    text: 'Cancel',
                    style: 'cancel'
        ...
        <View style={styles.container}>
            ...
            >
                <View style={styles.headerContent}>
                    ...
                    <View style={styles.headerTextContainer}>
                        <Text style={styles.headerTitle}>Sales Journal</Text>
                        <Text style={styles.headerSubtitle}>Track all sales-related transactions</Text>
                    </View>
            ...
            <View style={styles.summarySection}>
                <Text style={styles.summaryText}>
                    Showing {filteredAndSortedData.length} of {salesJournalData.length} entries
                </Text>
                <Text style={styles.summaryBalance}>
                    Total Sales: {formatCurrency(totalCredit)}
                </Text>
            </View>
...
export default SalesJournalScreen;